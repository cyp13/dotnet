...
//增加选项卡
function menuItem(menuName, dataUrl) {
	var dataIndex = menuName;
	if (!dataIndex || !menuName || !dataUrl) {
		// 获取标识数据
...
//关闭选项卡菜单
function closeItem(dataUrl) {
	if(dataUrl) {
		$('.J_menuTab[data-id="' + dataUrl + '"] i').click();
	}
}
