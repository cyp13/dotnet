...
<script>
	var insertUrl = "${ctx}/jsp/sys/insertUserRole.do";
	var deleteUrl = "${ctx}/jsp/sys/deleteUserRole.do";
	var queryUrl = "${ctx}/jsp/sys/queryUserByRole.do";
	...
	$(window).ready(function() {
		queryUserByRole("role", "leftdatas");
		...
		$("a[href=#tab-2]").on("click", function() {
			queryUserByRole("all","rightdatas");
	...
	var table;
	var queryUserByRole = function(flag, id) {
		table = $("#"+id).dataTable({
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
   					<div class="ibox-title">
	                    <h5><i class="fa fa-user-circle"></i> 成员列表（角色：${param.roleName}）</h5>
