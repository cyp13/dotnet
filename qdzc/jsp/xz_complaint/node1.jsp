...
<script>
var queryUrl = "${ctx}/jsp/work/queryXZComplaint.do";
var queryXiezuoHisUrl = "${ctx}/jsp/work/queryXZComplaintExt.do";
 		...
 		$(".action").on("change",function(){
 			...
 			if($(this).val()=="发布"){
 				...
 				$(".readonly").attr('readonly','readonly');
 		 		...
 		 		$("#reserve_time").removeAttr('disabled');
 		 		$("#fileUpload").removeClass("hide");
 			}
 			else{
 				$(".dataForm input,.dataForm textarea").attr('readonly','readonly');
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subXZComplaint.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control validate[required]" readonly="readonly" name="client_phone" id="client_phone" maxlength="11">
							    </div>
							     <label class="col-sm-1 control-label">209/10号码</label>
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control " readonly="readonly" name="number" id="number" maxlength="18">
							    </div>
							  </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<textarea rows="3" class="form-control validate[required]" readonly="readonly"  name="user_address" id="user_address" maxlength="50"></textarea>
							    </div>
							     <label class="col-sm-1 control-label">预约时间</label>
							    <div class="col-sm-4">
							    	<input type="text"  readonly="readonly" disabled="disabled" class="input-sm  form-control date_time" format="yyyy-MM-dd"  name="reserve_time" id="reserve_time" >
							    </div>
							  </div>
