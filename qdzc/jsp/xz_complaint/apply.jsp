...
//var yibanUrl = '${ctx}/jsp/';//已办列表URL
 	$(window).ready(function() { 
 		...
 		for (var r = 0; r < roleObj.length; r++) {
			if("协作投诉支撑"==roleObj[r].roleName){
				$("#zhuanpai").removeClass("hide");
				$("#roleNames_").addClass("validate[required]");
				$("#editForm").attr("action","${ctx}/jsp/work/insertXZComplaint4ZC.do");
				$("#taskName").val("协作投诉支撑");
				break;
			}else {
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/insertXZComplaint.do"  method="post" class="form-horizontal key-13" >
