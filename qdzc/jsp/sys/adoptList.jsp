...
<script>
var insertUrl = "${ctx}/jsp/work/insertAdopt.do";
var updateUrl = "${ctx}/jsp/work/updateAdopt.do";
var deleteUrl = "${ctx}/jsp/work/deleteAdopt.do";
var queryUrl = "${ctx}/jsp/work/queryAdopt.do";
var table ;
function sub(id){
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
   					<div class="ibox-title">
	                    <h5><i class="fa fa-leanpub"></i> 接单管理列表</h5>
	        ...
	        <div class="modal-content ibox">
                <form id="editForm" class="form-horizontal key-13" role="form">
		            ...
		            <div class="ibox-content">
					  ...
					  <input type="text" class="input-sm form-control hide" value="${myUser.userName}" name="user_id" id="user_id" >
					  
					   <div class="form-group">
					   <label class="col-sm-2 control-label">不接单开始时间</label>
					    <div class="col-sm-4">
					    	<input type="text" class="input-sm form-control validate[required]  date_picker_start"  name="start_time" id="startTime" >
					    </div>
					    
					     <label class="col-sm-2 control-label">不接单结束时间</label>
					    <div class="col-sm-4">
					      <input type="text" class="input-sm form-control validate[required] date_picker_end"  name="end_time" id="endTime" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
						     ...
						     <label  class="col-sm-2 control-label">状态</label>
							    <div class="col-sm-4">
							      <s:dict dictType="rowValid" type="radio" name="status"></s:dict>
							 </div>
