...
//var yibanUrl = '${ctx}/jsp/';//已办列表URL
 	$(window).ready(function() { 
 		...
 		for (var r = 0; r < roleObj.length; r++) {
			if("宽带扩容支撑"==roleObj[r].roleName){
				$("#zhuanpai").removeClass("hide");
				$("#roleNames_").addClass("validate[required]");
				$("#editForm").attr("action","${ctx}/jsp/work/insertBroadbandExpansion4ZC.do");
				$("#taskName").val("宽带扩容支撑");
				break;
			}else {
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/insertBroadbandExpansion.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<s:dict dictType="pe_plot_ai" name="pe_plot_ascription" type="select" clazz="validate[required] form-control" ></s:dict>
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<textarea rows="3" class="form-control validate[required]"  name="pe_plot_address" id="pe_plot_address" maxlength="50" ></textarea>
							    </div>
							  </div>
