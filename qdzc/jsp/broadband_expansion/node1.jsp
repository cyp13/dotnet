            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subBroadbandExpansion.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control validate[required]" readonly="readonly" name="be_client_number" id="be_client_number" maxlength="10" >
							    </div>
							     <label class="col-sm-1 control-label">客户手机号码1</label>
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control " readonly="readonly" name="client_phone1" id="client_phone1" maxlength="11">
							    </div>
							  </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control " readonly="readonly" name="client_phone2" id="client_phone2" maxlength="11">
							    </div>
							     <label class="col-sm-1 control-label">客户手机号码3</label>
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control " readonly="readonly" name="client_phone3" id="client_phone3" maxlength="11">
							    </div>
							  </div>
