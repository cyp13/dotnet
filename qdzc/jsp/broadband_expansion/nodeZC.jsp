...
<script>
var queryUrl = "${ctx}/jsp/work/queryBroadbandExpansion.do";
var queryXiezuoHisUrl = "${ctx}/jsp/work/queryBroadbandExpansionExt.do";
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subBroadbandExpansion4ZC.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
							   		 <label class="col-sm-2 control-label">宽带扩容登记类型</label>
								    <div class="col-sm-4">
								    	<s:dict dictType="be_type" name="title" type="select" clazz="validate[required] form-control" ></s:dict>
								    </div>
								    <label class="col-sm-1 control-label">工单编号</label>
								    <div class="col-sm-4">
								    	<input class="input-sm form-control readonly" name="form_code" id="form_code"/>
								    </div>
							   </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text"   class="input-sm  form-control readonly"  name="publish_time" id="publish_time" >
							    </div>
							  </div>
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
							  	<label class="col-sm-2 control-label">扩容登记涉及客户数</label>
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control validate[required] " name="be_client_number" id="be_client_number" maxlength="10" >
							    </div>
							     <label class="col-sm-1 control-label">客户手机号码1</label>
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control " name="client_phone1" id="client_phone1" maxlength="11">
							    </div>
							  </div>
							  
							  <div class="form-group">
							  	<label class="col-sm-2 control-label">客户手机号码2</label>
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control " name="client_phone2" id="client_phone2" maxlength="11">
							    </div>
							     <label class="col-sm-1 control-label">客户手机号码3</label>
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control " name="client_phone3" id="client_phone3" maxlength="11">
							    </div>
							  </div>
							  
							  <div class="form-group">
							  	<label class="col-sm-2 control-label">登记扩容小区归属</label>
							    <div class="col-sm-4">
							    	<s:dict dictType="pe_plot_ai" name="pe_plot_ascription" type="select" clazz=" form-control validate[required]" ></s:dict>
							    </div>
							     
							  </div>
							  
							  <div class="form-group">
							     <label class="col-sm-2 control-label">登记扩容小区详细地址</label>
							    <div class="col-sm-4">
							    	<textarea rows="3" class="form-control validate[required]" readonly="readonly"  name="pe_plot_address" id="pe_plot_address" maxlength="50"></textarea>
							    </div>
							  </div>
							   	...
							   	<div class="form-group">
								    ...
								    <div class="col-sm-4">
									  <select name="result" id="result"  class="form-control">
									  	 <c:if test="${param.taskName eq '协作人员'}">
