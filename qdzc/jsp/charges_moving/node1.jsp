...
<script>
var queryUrl = "${ctx}/jsp/work/queryChargesMoving.do";
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subChargesMoving.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control validate[required, custom[mobile]]" name="user_phone" id="user_phone" maxlength="11">
							    </div>
							  </div>
							...
							<div class="form-group tag_ifsuccess">
						   		...
						   		<div class="col-sm-8">
							   		<textarea rows="1" class="form-control validate[required]" id="tag_ifsuccess" name="tag_ifsuccess" maxlength="50" placeholder="请手动输入,限50字"></textarea>
						   		</div>
						    </div>
							  ...
							  <div id="evaluate" class="hide">
							   ...
							   <hr>
							    <c:if test="${param.taskName eq '资费迁转支撑'}">
								 <div class="form-group">
