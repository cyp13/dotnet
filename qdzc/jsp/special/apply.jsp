            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/insertSpecial.do"  method="post" class="form-horizontal key-13" >
			                  ...
			                  <input type="text" id="taskName" name="taskName" value="渠道人员" style="display:none"/>
							   ...
							   <div class="form-group">
								    ...
								    <div class="col-sm-4">
								    	<input class="input-sm form-control validate[required]" readonly="readonly" value="专线工单" name="title" id="title"/>
								    </div>
						    ...
						    <!-- 变更start -->
				 			<div   id="work_biangeng" style="display: none;">
					 			...
					 			<div class="form-group">
								    <!--专线号-->
								    <label class="col-sm-1 control-label col-sm-offset-1">专线号</label>
								    <div class="col-sm-4">
