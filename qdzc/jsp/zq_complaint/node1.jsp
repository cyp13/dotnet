...
<script>
var queryUrl = "${ctx}/jsp/work/queryZQComplaint.do";
var queryXiezuoHisUrl = "${ctx}/jsp/work/queryZQComplaintExt.do";
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subZQComplaint.do"  method="post" class="form-horizontal key-13" >
