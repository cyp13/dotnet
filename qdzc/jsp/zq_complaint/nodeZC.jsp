            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subZQComplaint4ZC.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
								    ...
								    <div class="col-sm-4">
								    	<s:dict dictType="complaint_type" name="title" type="select" clazz="form-control validate[required] " ></s:dict>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text"  disabled="disabled" class="input-sm  form-control validate[required] date_time" format="yyyy-MM-dd"  name="reserve_time" id="reserve_time" >
							    </div>
							  </div>
