...
<jsp:include page="/jsp/_p/node1.jsp"></jsp:include>
<script>
</script>
</head>
<body class="gray-bg">
<div class="wrapper wrapper-content animated fadeIn">
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<label>
				<input type="radio" name="IN_CONTROL" value="归档" checked="checked"/><span style="padding: 0px 10px 0px 5px;">解决</span>
			</label>
			<label>
				<input type="radio" name="IN_CONTROL" value="发布"/><span style="padding: 0px 10px 0px 5px;">未解决</span>
			</label>
		</div>
	</div>
	<div id="evaluate">
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="radio" name="ext1" value="1"/>1星 
			<input type="radio" name="ext1" value="2"/>2星 
			<input type="radio" name="ext1" value="3"/>3星
			<input type="radio" name="ext1" value="4"/>4星
			<input type="radio" name="ext1" value="5" checked="checked"/>5星
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label">评价</label>
		<div class="col-sm-9">
			<textarea rows="5" class="form-control" name="ext2" id="ext2" placeholder="请填写评价"></textarea>
		</div>
	</div>
	</div>
	<div id="noevaluate" style="display: none;">
		<div id="fileUpload">
			<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="node" style="display: none;" value="1"/>
