...
<script>
var queryUrl = "${ctx}/jsp/work/queryProgressFeedback.do";
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subProgressFeedback.do"  method="post" class="form-horizontal key-13" >
							   	...
							   	<div class="form-group">
								    ...
								    <div class="col-sm-4">
									  <select name="result" id="result"  class="form-control">
									   <c:if test="${param.taskName eq '酬金进度反馈支撑'}">
										  	<option value="回复">回复</option>
										  	<option value="转派">转派</option>
										  	<option value="驳回">驳回</option>
									  	</c:if>
									  	 <c:if test="${param.taskName eq '二级酬金进度反馈支撑'}">
									  	 	<option value="回复">回复</option>
