...
<script>
var queryUrl = "${ctx}/jsp/work/querySupervise.do";
var queryXiezuoHisUrl = "${ctx}/jsp/work/querySuperviseExt.do";
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subSupervise4ZC.do"  method="post" class="form-horizontal key-13" >
			                  ...
			                  <div class="dataForm">
							   <div class="form-group">
							   		 <label class="col-sm-2 control-label">督办主题</label>
								    <div class="col-sm-4">
								    	<s:dict dictType="dbgd_type" name="title" type="select" clazz="validate[required] form-control" ></s:dict>
								    </div>
								    <label class="col-sm-1 control-label">督办类型</label>
								    <div class="col-sm-4">
								    	<input type="text" class="input-sm form-control validate[required]" name="supervise_type" id="supervise_type" maxlength="20"/>
								    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control readonly" value="${myUser.userAlias}"  name="publisher" id="publisher" readonly>
							    </div>
							   ...
							   <div class="form-group">
								  <label class="col-sm-2 control-label">联系方式</label>
								    <div class="col-sm-4">
								     	<input type="number" class="input-sm form-control readonly" title="请确认您的个人信息中移动电话是否填写！" value="${myUser.mobilePhone}"  readonly name="user_phone" id="user_phone" >
								    </div>
								</div>
		
							  <div class="form-group">
							  	<label class="col-sm-2 control-label">涉及客户</label>
								    <div class="col-sm-4">
								    	<input type="text" class="input-sm form-control validate[required]" name="involve_client" id="involve_client" maxlength="20"/>
								    </div>
