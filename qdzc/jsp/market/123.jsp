            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/market/insertMarket.do"  method="post" class="form-horizontal key-13" > 
						 ...
						 <div class="form-group">  
						    ...
						    <div class="col-sm-9">
 							<textarea rows="5" class="form-control validate[required]" maxlength="300" name="ARTICLE_PAGE" id="description" ></textarea>
 						    </div>
						</div>
