...
<script>
var queryUrl = "${ctx}/jsp/work/queryComplaint.do";
var queryXiezuoHisUrl = "${ctx}/jsp/work/queryComplaintExt.do";
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subComplaint.do"  method="post" class="form-horizontal key-13" >
