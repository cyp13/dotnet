...
//var yibanUrl = '${ctx}/jsp/';//已办列表URL
 	$(window).ready(function() { 
 		...
 		for (var r = 0; r < roleObj.length; r++) {
			if("堵点投诉支撑"==roleObj[r].roleName){
				$("#zhuanpai").removeClass("hide");
				$("#roleNames_").addClass("validate[required]");
				$("#editForm").attr("action","${ctx}/jsp/work/insertComplaint4ZC.do");
				$("#taskName").val("堵点投诉支撑");
				break;
			}else {
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/insertComplaint.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text"  readonly="readonly"  class="input-sm  form-control date_time validate[required]" format="yyyy-MM-dd"  name="reserve_time" id="reserve_time" >
							    </div>
							  </div>
