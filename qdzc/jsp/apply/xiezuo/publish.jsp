		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/insertXiezuo.do"  method="post" class="form-horizontal key-13" >
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text" class="input-sm form-control" value="${myUser.org.orgName}"  name="channel_name" id="channel_name" readonly>
							    </div>
							  </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							     	<input type="number" class="input-sm form-control " title="请确认您的个人信息中移动电话是否填写！" value="${myUser.mobilePhone}"  readonly name="channel_phone" id="channel_phone" >
							    </div>
							  </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<select class="input-sm form-control validate[required]" id="service_type" name="service_type" >
							    		...
							    		<option value="市场部部室工单">市场部部室工单</option>
							    		<option value="宽带督办工单">宽带督办工单</option>
							    	</select>							   		
							    	<input type="text" class="hide" id="service_type_name" name="service_type_name" />
							    </div>
							     <label class="col-sm-1 control-label">用户号码</label>
							    <div class="col-sm-4">							    	
