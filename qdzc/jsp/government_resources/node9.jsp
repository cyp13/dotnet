 	...
 	$(window).ready(function() {
		...
		$("#btn-ok").on("click", function() {
		 ...
		 $('input[name=action]').change(function(){
			 if ($(this).val() == "归档" || $(this).val() == "回退到全业务支撑") {
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subGovernmentResources.do"  method="post" class="form-horizontal key-13" >
						   ...
						   <div class="form-group">
								...
								<div class="col-sm-4">
									<label>
										<input type="radio" name="action" value="归档" checked="checked" id="archive"/><span style="padding: 0px 10px 0px 5px;">确认</span>
									</label>
									<label>
										<input type="radio" name="action" value="回退"/><span style="padding: 0px 10px 0px 5px;">退回</span>
									</label> 
									<label>
										<input type="radio" name="action" value="回退到全业务支撑"/><span style="padding: 0px 10px 0px 5px;">回退到全业务支撑</span>
									</label> 
								</div>
							</div>
							...
							<input type="hidden" value="1" name="node" id="node">
						   <div class="form-group">
