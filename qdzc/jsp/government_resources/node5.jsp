		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subGovernmentResources.do"  method="post" class="form-horizontal key-13" >
						   ...
						   <div class="form-group">
								...
								<div class="col-sm-4">
									<label>
										<input type="radio" name="result" value="完成异常修复" checked="checked" id="archive"/><span style="padding: 0px 10px 0px 5px;">完成异常修复</span>
									</label>
									<label>
										<input type="radio" name="result" value="回退到施工单位"/><span style="padding: 0px 10px 0px 5px;">退回</span>
									</label> 
									<label>
