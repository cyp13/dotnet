 	...
 	$(window).ready(function() {
 		...
 		if(pid){
			...
			ajax(obj, function(data){
				...
				if (row.sjy_result == "PON数据专线/数据申请") {
					$('#handle2').remove();
				}else {
					$('#handle1').remove();
					$('#sign').val("5");
		...
		$("#btn-ok").on("click", function() {
		 ...
		 $('input[name=cszx_result1]').change(function(){
			 if ($(this).val() == "回退到设计院") {
				 $('.accessory').hide();
		 ...
		 $('input[name=cszx_result2]').change(function(){
			 if ($(this).val() == "回退到设计院") {
				 $('.accessory').hide();
				 $('.accessory input').removeClass('validate[required]');
				 $('#opinion textarea').addClass('validate[required]');
                       ...
                       <form id="editForm" action="${ctx}/jsp/work/subGovernmentResources.do"  method="post" class="form-horizontal key-13" >
						  ...
						  <div id="handle1">
							   <div class="form-group">
									...
									<div class="col-sm-4">
										<label>
											<input type="radio" name="cszx_result1" value="完成数据配置（PON数据专线）" checked="checked" id="archive"/><span style="padding: 0px 10px 0px 5px;">完成数据配置</span>
										</label>
										<label>
											<input type="radio" name="cszx_result1" value="回退到设计院"/><span style="padding: 0px 10px 0px 5px;">退回</span>
										</label>
										<label>
											<input type="radio" name="cszx_result1" value="回退到全业务支撑"/><span style="padding: 0px 10px 0px 5px;">回退到全业务支撑</span>
										</label>
									</div>
								</div>
						  ...
						  <div id="handle2">
							   ...
							   <div class="form-group">
									...
									<div class="col-sm-4">
										<label>
											<input type="radio" name="cszx_result2" value="完成数据配置（非PON）" checked="checked" id="archive"/><span style="padding: 0px 10px 0px 5px;">完成数据配置</span>
										</label>
										<label>
											<input type="radio" name="cszx_result2" value="回退到设计院"/><span style="padding: 0px 10px 0px 5px;">退回</span>
										</label>
										<label>
											<input type="radio" name="cszx_result2" value="回退到全业务支撑"/><span style="padding: 0px 10px 0px 5px;">回退到全业务支撑</span>
										</label>
									</div>
								</div>
								<div class="form-group accessory">
