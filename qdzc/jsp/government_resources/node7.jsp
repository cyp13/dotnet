...
var taskName = '${param.taskName}';
 	...
 	$(window).ready(function() {
		...
		$("#btn-ok").on("click", function() {
		 ...
		 $('input[name=xcj_result1]').change(function(){
			 if ($(this).val() == "回退到传输中心") {
				 $('.accessory').hide();
		 ...
		 $('input[name=xcj_result2]').change(function(){
			 if ($(this).val() == "回退") {
				 $('.accessory').hide();
				 $('.accessory input').removeClass('validate[required]');
				 $('#opinion textarea').addClass('validate[required]');
                       ...
                       <form id="editForm" action="${ctx}/jsp/work/subGovernmentResources.do"  method="post" class="form-horizontal key-13" >
						   ...
						   <div  id="handle1">
							   ...
							   <div class="form-group">
									...
									<div class="col-sm-4">
										<label>
											<input type="radio" name="xcj_result1" value="完成数据导入" checked="checked"/><span style="padding: 0px 10px 0px 5px;">完成数据导入</span>
										</label>
										<label>
											<input type="radio" name="xcj_result1" value="回退到传输中心"/><span style="padding: 0px 10px 0px 5px;">退回</span>
										</label> 
										<label>
											<input type="radio" name="xcj_result1" value="回退到全业务支撑"/><span style="padding: 0px 10px 0px 5px;">回退到全业务支撑</span>
										</label> 
									</div>
								</div>
							</div>
							...
							<div id="handle2">
							   <div class="form-group">
									...
									<div class="col-sm-4">
										<label>
											<input type="radio" name="xcj_result2" value="完成资源录入" checked="checked"/><span style="padding: 0px 10px 0px 5px;">完成资源录入</span>
										</label>
										<label>
											<input type="radio" name="xcj_result2" value="回退"/><span style="padding: 0px 10px 0px 5px;">退回</span>
										</label> 
										<label>
											<input type="radio" name="xcj_result2" value="回退到全业务支撑"/><span style="padding: 0px 10px 0px 5px;">回退到全业务支撑</span>
										</label> 
									</div>
								</div>
							</div>
