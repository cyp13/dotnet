 	...
 	$(window).ready(function() {
		...
		$("#btn-ok").on("click", function() {
		 ...
		 $('input[name=result]').change(function(){
			 if ($(this).val() == "有资源") {
				 $('#zjjxzp').show();
				 $('#zjjxzp input').addClass('validate[required]');
				 $('#opinion textarea').addClass('validate[required]');
			}else if ($(this).val() == "回退到全业务支撑") {
				$('#zjjxzp').hide();
				$('#zjjxzp input').removeClass('validate[required]');
		            ...
		            <div class="ibox-content">
                       <form id="editForm" action="${ctx}/jsp/work/subGovernmentResources.do"  method="post" class="form-horizontal key-13" >
						   ...
						   <div class="form-group">
								...
								<div class="col-sm-4">
									<label>
										<input type="radio" name="result" value="有资源" checked="checked" id="archive"/><span style="padding: 0px 10px 0px 5px;">有资源</span>
									</label>
									<label>
										<input type="radio" name="result" value="无资源"/><span style="padding: 0px 10px 0px 5px;">无资源</span>
									</label> 
									<label>
							...
							<div class="form-group" id="zjjxzp">
							   	<label  class="col-sm-2 control-label">装机机箱照片</label>
							    <div class="col-sm-9">
							...
							<div class="form-group" id="opinion">
								...
								<div class="col-sm-9">
									<textarea rows="3" class="form-control validate[required]" name="opinion" maxlength="200" placeholder="请填写处理意见 "></textarea>
								</div>
							</div>
