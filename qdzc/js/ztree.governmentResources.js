...
var queryOrgUserUrl = "/qdzc/jsp/work/queryUserByOrgForGovernmentResources.do";
...
function getOrgUser(orgId){
	...
	ajax(param, function(data){
		if(data.Rows.length>0){
			formatData(data.Rows,"user_name","user_alias","select","#customer_manager","role_name");
		}else{
